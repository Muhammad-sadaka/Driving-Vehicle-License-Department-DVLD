...
namespace DVLD
{
    public partial class ctrlScheduleTest : UserControl
    {
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID, int AppointmentID = -1)
        {
            ...
            {
                lblRAppFees.Text = clsApplicationTypes.FindByID((int)clsApplications.enApplicationType.RetakeTest).Fees.ToString();
                gBRerakeTestInfo.Enabled = true;
                lblTitle.Text = "Schedule Retake Test";
                lblRTestAppID.Text = "0";
            }
            else
            {
                gBRerakeTestInfo.Enabled = false;
            ...
            {
                lblFees.Text = clsTestTypes.FindByID(_TestTypeID).Fees.ToString();
        ...
        {
            _TestAppointment = clsTestAppointments.GetTestAppointmentInfoByID(_TestAppointmentID);
        ...
        private bool _HandleRetakeApplication()
        {
            ...
            if (_Mode == enMode.AddNew && _CreationMode == enCreationMode.RetakeTestSchedule)
            {
                ...
                Application.PaidFees = clsApplicationTypes.FindByID((int)clsApplications.enApplicationType.RetakeTest).Fees;
