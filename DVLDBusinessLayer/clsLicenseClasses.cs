...
namespace DVLDBusinessLayer
{
    public class clsLicenseClasses
    {
        ...
        private bool _AddNewLicenseClass()
        {
            ...
            this.LicenseClassID = clsLicenseClassesDataAccess.AddNewLicenseClass(this.ClassName, this.ClassDescription,
        ...
        private bool _UpdateLicenseClass()
        {
            ...
            return clsLicenseClassesDataAccess.UpdateLicenseClass(this.LicenseClassID, this.ClassName, this.ClassDescription,
                this.MinimumAllowedAge, this.DefaultValidityLength, this.ClassFees);
        }
        ...
        public static clsLicenseClasses Find(string ClassName)
        {
            ...
            if (clsLicenseClassesDataAccess.GetLicenseClassInfoByClassName(ClassName, ref LicenseClassID, ref ClassDescription,
                    ref MinimumAllowedAge, ref DefaultValidityLength, ref ClassFees))
